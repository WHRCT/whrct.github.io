...
window.addEventListener('load', function () {
    ...
    setTimeout(function () {
        iziToast.show({
            timeout: 4000,
            title: hello,
            message: '访客，您好！欢迎来到王浩瑞的主页'
        });
    }, 800);
}, false)

setTimeout(function () {
    $('#loading-text').html("字体及文件加载可能需要一定时间，请耐心等候")
}, 3000);

//延迟加载音乐播放器
function downloadJSAtOnload() {
    var element = document.createElement("script");
    element.src = "https://cloud.lxweb.cn/f/qL8ie/music.js";
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change1").html("一个建立于 21 世纪的小站，王浩瑞的个人主页");
    }
});
